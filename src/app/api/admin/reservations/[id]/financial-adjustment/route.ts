    ...
    const result = await prisma.$transaction(async (tx) => {
      ...
      await tx.reservation.update({
        ...
        data: {
          ...
          customerDiscountMode: reservation.customerDiscountMode,
          customerDiscountValue: reservation.customerDiscountValue,
          customerDiscountCents: reservation.customerDiscountCents,
          autoDiscountCents: 0,
