...
import PartDetailOverviewSection from "./_components/PartDetailOverviewSection";
      ...
      >
        <div>
          ...
          <div style={{ opacity: 0.76, fontSize: 14 }}>
            Ficha técnica, movimientos de stock y trazabilidad de uso en mantenimiento.
          </div>
        </div>
